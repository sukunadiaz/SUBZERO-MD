...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "SUBZERO-MD~wtbnFbtHju7W4cWuasOc",  // Your bot's session ID (keep it secure)
    PREFIX: getConfig("PREFIX") || "?",  // Command prefix (e.g., "., / ! * - +")
    BOT_NAME: process.env.BOT_NAME || getConfig("BOT_NAME") || "Diaz MD",  // Bot's display name
    MODE: getConfig("MODE") || process.env.MODE || "public",        // Bot mode: public/private/group/inbox
    REPO: process.env.REPO || "https://github.com/mrfrankofcc/SUBZERO-MD",  // Bot's GitHub repo
    BAILEYS: process.env.BAILEYS || "@whiskeysockets/baileys",  // Bot's BAILEYS

    // ===== OWNER & DEVELOPER SETTINGS =====
    OWNER_NUMBER: process.env.OWNER_NUMBER || "2349166818712",  // Owner's WhatsApp number
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "Bishop Diaz",           // Owner's name
    DEV: process.env.DEV || "2349166818712",                     // Developer's contact number
    DEVELOPER_NUMBER: '2349166818712@s.whatsapp.net',            // Developer's WhatsApp ID

    // ===== AUTO-RESPONSE SETTINGS =====
    AUTO_REPLY: process.env.AUTO_REPLY || "false",              // Enable/disable auto-reply
    AUTO_STATUS_REPLY: process.env.AUTO_STATUS_REPLY || "false",// Reply to status updates?
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*Diaz Bot VIEWED YOUR STATUS 🤖*",  // Status reply message
    ...
    STICKER_NAME: process.env.STICKER_NAME || "Diaz MD",     // Sticker pack name
    ...
    FOOTER: process.env.FOOTER || "*© Bishop Dennis*",  // Bot description
